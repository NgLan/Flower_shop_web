...
<!-- Mirrored from html.themexriver.com/organio/cart.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Apr 2022 17:44:57 GMT -->
<head>
	<meta charset="UTF-8">
				...
				<div class="row">
							...
							<table class="table">
								...
								<tbody>
									...
									<tr>
										...
										<td class="product-thumbnail"> <a href="#"><img src="assets/img/product/pro2.jpg" class="cart-thumb-img" alt=""></a></td>
										<td class="product-name" data-title="Product"> <a href="#">Fresh - Orange, 0.5 Kg</a></td>
										<td class="product-price product-subtotal" data-title="Price"> <span class=" amount"><bdi><span class="Price-currencySymbol">$</span>89.00</bdi></span></td>
										<td>
											<div class="quantity-field position-relative  d-inline-block">
												<input type="text" name="select1" value="1" class="quantity-input-arrow quantity-input-2  text-center">
											</div>
									...
									<tr>
										...
										<td class="product-thumbnail"> <a href="#"><img src="assets/img/product/pro3.jpg" class="cart-thumb-img" alt=""></a></td>
										<td class="product-name" data-title="Product"> <a href="#">Organic Cabbage - Onion, 2.0 Kg</a></td>
										<td class="product-price product-subtotal" data-title="Price"> <span class=" amount"><bdi><span class="Price-currencySymbol">$</span>24.00</bdi></span></td>
										<td>
											<div class="quantity-field position-relative  d-inline-block">
												<input type="text" name="select1" value="1" class="quantity-input-arrow quantity-input-2  text-center">
											</div>
									...
									<tr>
										...
										<td class="product-thumbnail"> <a href="#"><img src="assets/img/product/pro4.jpg" class="cart-thumb-img" alt=""></a></td>
										<td class="product-name" data-title="Product"> <a href="#">Healthy Bread, 2.3 Kg</a></td>
										<td class="product-price product-subtotal" data-title="Price"> <span class=" amount"><bdi><span class="Price-currencySymbol">$</span>13.00</bdi></span></td>
										<td>
											<div class="quantity-field position-relative  d-inline-block">
												<input type="text" name="select1" value="1" class="quantity-input-arrow quantity-input-2  text-center">
											</div>
					...
					<div class="col-lg-4">
						<div class="or-cart-total-warpper text-center headline pera-content top-sticky">
							...
							<a class="d-flex justify-content-center align-items-center" href="checkout.jsp">Procced To Checkout</a>
						</div>
					</div>
				</div>
			</div>
						...
						<div class="or-footer-widget headline pera-content ul-li-block">
							<div class="or-contact-widget">
								...
								<ul>
									...
									<li><i class="fas fa-envelope"></i> <span> <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="c2abaca4ad82a7acb4a3b6adeca1adaf">[email&#160;protected]</a>  </span> </li>
								</ul>
...
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"8a127cad7e140964","r":1,"version":"2024.4.1","token":"1a8b05cf689d4ce9a19f3112169b7af3"}' crossorigin="anonymous"></script>
</body>
