...
<!-- Mirrored from html.themexriver.com/organio/index-1.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Apr 2022 17:43:44 GMT -->
<head>
	<meta charset="UTF-8">
						...
						<ul class="menu-navigation left-nav">
							<li class="dropdown">
								...
								<ul class="dropdown-menu clearfix">
									<li><a target="_blank" href="index.jsp">Home Page 1</a></li>
					...
					<div class="col-lg-6">
						<div class="or-shop-banner-innerbox position-relative wow fadeInUp ">
							<div class="or-shop-banner-text headline pera-content">
								...
								<a class="sb-btn wow fadeInUp" href="shop.jsp">Shop Now <i class="fas fa-long-arrow-right"></i></a>
							</div>
					...
					<div class="or-category-slider-area">
						<div class="organio-inner-item">
							<div class="or-category-slider-inner-item text-center position-relative type-1">
								<div class="or-category-img position-relative">
									<img src="assets/img/shop/cat-1.png" alt="">
								...
								<div class="or-category-text headline pera-content">
									...
									<div class="item-more position-relative">
										<a href="shop-single.jsp"><i class="icon-first far fa-long-arrow-right"></i> Shop now <i class="icon-last far fa-long-arrow-right"></i></a>
									</div>
								</div>
							</div>
						</div>
						<div class="organio-inner-item">
							<div class="or-category-slider-inner-item text-center type-2 position-relative">
								<div class="or-category-img position-relative">
									<img src="assets/img/shop/cat-2.png" alt="">
						...
						<div class="organio-inner-item">
							<div class="or-category-slider-inner-item text-center type-3 position-relative">
								<div class="or-category-img position-relative">
									<img src="assets/img/shop/cat-3.png" alt="">
						...
						<div class="organio-inner-item">
							<div class="or-category-slider-inner-item text-center type-4 position-relative">
								<div class="or-category-img position-relative">
									<img src="assets/img/shop/cat-4.png" alt="">
...
<!-- Start of Best Deal section
	============================================= -->
	<section id="or-best-deal" class="or-best-deal-section position-relative" data-background="assets/img/bg/bd-bg.jpg">
		<div class="container">
			<div class="or-best-deal-content-wrapper position-relative">
				...
				<div class="or-best-deal-img" data-parallax='{"y" : 100}'>
					<img src="assets/img/bg/bd.png" alt="">
				</div>
			</div>
		</div>
	</section>
					...
					<div class="or-team-slider">
							...
							<div class="or-team-innerbox">
								...
								<div class="or-taam-item-holder">
									<div class="or-team-meta text-center headline position-relative">
										<h3><a href="team-single.jsp">Alisa Lisa</a></h3>
						...
						<div class="organio-inner-item">
							<div class="or-team-innerbox">
								...
								<div class="or-taam-item-holder">
									<div class="or-team-meta text-center headline position-relative">
										<h3><a href="team-single.jsp">Robert Leo</a></h3>
										<span>Farmer</span>
										<div class="team-item-side-img">
											<img class="side-img" src="assets/img/icon/t-icon2.png" alt="">
											<img class="side-img" src="assets/img/icon/t-icon1.png" alt="">
						...
						<div class="organio-inner-item">
							<div class="or-team-innerbox">
								...
								<div class="or-taam-item-holder">
									<div class="or-team-meta text-center headline position-relative">
										<h3><a href="team-single.jsp">Nora Bell</a></h3>
			...
			<div class="or-portfolio-wrapper position-relative">
				<div class="or-portfolio-slider">
					<div class="organio-inner-item">
						<div class="or-portfolio-innerbox position-relative">
							...
							<div class="or-portfolio-text headline">
								<h3><a href="project-single.jsp">Organic Grape</a></h3>
								<span><a href="#">Farming fruits</a></span>
								<a class="read-more d-flex justify-content-center align-items-center" href="project-single.jsp"><img src="assets/img/icon/arrow2.png" alt=""></a>
							</div>
						</div>
					</div>
					<div class="organio-inner-item">
					...
					<div class="organio-inner-item">
						<div class="or-portfolio-innerbox position-relative">
							<div class="or-portfolio-img">
								<img src="assets/img/portfolio/port6.jpg" alt="">
							</div>
							<div class="or-portfolio-text headline">
								<h3><a href="project-single.jsp">Organic Grape</a></h3>
								<span><a href="#">Farming fruits</a></span>
					...
					<div class="organio-inner-item">
						<div class="or-portfolio-innerbox position-relative">
							<div class="or-portfolio-img">
								<img src="assets/img/portfolio/port7.jpg" alt="">
							</div>
							<div class="or-portfolio-text headline">
								<h3><a href="project-single.jsp">Organic Grape</a></h3>
								<span><a href="#">Farming fruits</a></span>
				...
				<div class="carousel_nav  clearfix">
					<button type="button" class="or-portfolio-left_arrow"><img src="assets/img/icon/arrow1.png" alt=""></button>
					<button type="button" class="or-portfolio-right_arrow"><img src="assets/img/icon/arrow2.png" alt=""></button>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container">
			...
			<div class="or-blog-content">
				...
				<div class="or-blog-btn">
					<a class="d-flex justify-content-center align-items-center" href="blog.jsp">View all posts <i class="far fa-long-arrow-right"></i></a>
				</div>
			</div>
		</div>
	</section>
						...
						<div class="or-footer-widget headline pera-content ul-li-block">
							<div class="or-contact-widget">
								...
								<ul>
									...
									<li><i class="fas fa-envelope"></i> <span> <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="ea83848c85aa8f849c8b9e85c4898587">[email&#160;protected]</a>  </span> </li>
								</ul>
...
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"8a1081a82ac60f1c","r":1,"version":"2024.4.1","token":"1a8b05cf689d4ce9a19f3112169b7af3"}' crossorigin="anonymous"></script>
</body>

<!-- Mirrored from html.themexriver.com/organio/index-1.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Apr 2022 17:44:13 GMT -->
</html>		