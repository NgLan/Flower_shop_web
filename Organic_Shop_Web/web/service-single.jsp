...
<!-- Mirrored from html.themexriver.com/organio/service-single.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Apr 2022 17:44:58 GMT -->
<head>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<title>Service Details | Organio</title>
				...
				<div class="organic-header-content  position-relative">
					...
					<nav class="main-navigation-area clearfix ul-li">
						<ul class="menu-navigation left-nav">
							<li class="dropdown">
								...
								<ul class="dropdown-menu clearfix">
									...
									<li><a target="_blank" href="index-2.jsp">Home Page 2</a></li>
									<li><a target="_blank" href="index-3.jsp">Home Page 3</a></li>
									<li class="dropdown">
										<a target="_blank" href="index-4.jsp">Home Page 4</a>
										<ul class="dropdown-menu clearfix">
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu clearfix">
									...
									<li><a target="_blank" href="checkout.jsp">Checkout</a></li>
								</ul>
							</li>
							<li class="dropdown">
								<a href="%21.jsp#">Pages</a>
								<ul class="dropdown-menu clearfix">
									<li><a target="_blank" href="service.jsp">Services</a></li>
									<li><a target="_blank" href="service-single.jsp">Services Details</a></li>
						...
						<ul class="menu-navigation right-nav">
							...
							<li class="dropdown">
								<a href="%21.jsp#">Project</a>
								<ul class="dropdown-menu clearfix">
									<li><a target="_blank" href="project.jsp">Project Page </a></li>
									<li><a target="_blank" href="project-single.jsp">Project Details </a></li>
								</ul>
							</li>			
						</ul>
					</nav>
	...
	<section id="or-breadcrumbs" class="or-breadcrumbs-section position-relative" data-background="assets/img/bg/bg-page-title.jpg">
		...
		<div class="container">
			<div class="or-breadcrumbs-content text-center">
				<div class="page-title headline"><h1>Service Details</h1></div>
					...
					<div class="col-lg-4">
						<div class="service-side-bar scroll-sticky">
							<div class="service-category ul-li-block">
								<ul>
									<li><a href="service-single.jsp">Agricultural Services</a></li>
									<li><a href="service-single.jsp">Tax Consulting</a></li>
									<li><a href="service-single.jsp">Finance Consulting</a></li>
									<li><a href="service-single.jsp">Investment Policy</a></li>
									<li><a href="service-single.jsp">Financial Advices</a></li>
								</ul>
							</div>
							<div class="service-add">
								<a href="#">
									<img src="assets/img/add2.jpg" alt="">
								</a>
							</div>
						</div>
					</div>
					<div class="col-lg-8">
						<div class="or-service-details-text">
							<div class="or-service-details-img">
								<img src="assets/img/bg/srd1.jpg" alt="">
							</div>
							<div class="or-service-details-text-wrap headline pera-content">
								<h3>Agricultural Services</h3>
								<p>Finance and the Institute of Information Science (IZUM) in Maribor, Slovenia, today announce that the first EuroHPC supercomputer is now operational. This is the ‘Vega’ supercomputer, based on Atos’ BullSequana XH2000 architecture, which is now installed following a start-up ceremony hosted by IZUM with the Prime Minister of the Republic of Slovenia, Janez Janša, in attendance, together with the Executive Vice-President of the European Commission Margrethe Vestager, the Minister of Education,</p>
								<div class="or-service-details-feature d-flex">
									<div class="or-service-details-ft-icon-text headline pera-content">
										<div class="or-service-details-ft-icon float-left">
											<img src="assets/img/icon/a-icon1.png" alt="icon">
										</div>
										<div class="or-service-details-ft-text">
											<h4><a href="#">Why Oranico?</a></h4>
									...
									<div class="or-service-details-ft-icon-text headline pera-content">
										...
										<div class="or-service-details-ft-text">
											<h4><a href="#">Speciality Produce</a></h4>
											<p>We're making room for self care today with plan.</p>
										</div>
									</div>
								</div>
								<div class="or-service-details-img-text-item">
									<div class="row">
										<div class="col-md-6">
											<div class="or-service-details-img-item">
												<img src="assets/img/about/single-service1.jpg" alt="">
											</div>
										</div>
										<div class="col-md-6">
											<div class="or-service-details-text-item">
												<h4>We will give you support!</h4>
												<p>Vega, the largest supercomputer in the country, is based at  a public infrastructural institution and research organization established by the Government of the Republic of Slovenia. It will be used to support the development.</p>
											</div>
										</div>
									</div>
								</div>
								<div class="or-service-commit d-flex">
									<div class="or-service-commit-inner d-flex align-items-center headline pera-content">
										<div class="or-service-commit-icon text-center float-left">
											<i class="far fa-crown"></i>
										</div>
										<div class="or-service-commit-text">
											<h3><a href="service-single.jsp">Best quality
											support</a></h3>
										</div>
									</div>
									<div class="or-service-commit-inner d-flex align-items-center headline pera-content">
										...
										<div class="or-service-commit-text">
											<h3><a href="service-single.jsp">Money back
											guarantee</a></h3>
										</div>
									</div>
									<div class="or-service-commit-inner d-flex align-items-center headline pera-content">
										...
										<div class="or-service-commit-text">
											<h3><a href="service-single.jsp">Cheap price
											provider</a></h3>
										</div>
									</div>
								</div>
								<div class="or-service-details-item">
									<div class="row">
										<div class="col-md-6">
											<div class="or-service-page-innerbox headline pera-content position-relative">
												<div class="grid-item-inner wow fadeInUp active" data-wow-duration="1.2s">
													...
													<div class="item--holder-hover">
														<div class="item--holder-inner">
															<h3 class="item--title">
																<a href="service-single.jsp">Agricultural Services</a>
															</h3>
															...
															<div class="item-readmore"> <a class="btn btn-animate" href="service-single.jsp"> <span> Read more </span> </a>
															</div>
														</div>
													</div>
												</div>
										...
										<div class="col-md-6">
											<div class="or-service-page-innerbox headline pera-content position-relative">
												<div class="grid-item-inner wow fadeInUp active" data-wow-duration="1.2s">
													...
													<div class="item--holder">
														<h3 class="item--title">Orginico Services</h3>
													</div>
													<div class="item--holder-hover">
														<div class="item--holder-inner">
															<h3 class="item--title">
						...
						<div class="or-footer-widget headline pera-content ul-li-block">
							<div class="or-contact-widget">
								...
								<ul>
									...
									<li><i class="fas fa-envelope"></i> <span> <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="452c2b232a05202b3324312a6b262a28">[email&#160;protected]</a>  </span> </li>
								</ul>
...
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"8a1295a76d786e5b","version":"2024.6.1","r":1,"token":"1a8b05cf689d4ce9a19f3112169b7af3","serverTiming":{}}' crossorigin="anonymous"></script>
</body>

<!-- Mirrored from html.themexriver.com/organio/service-single.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Apr 2022 17:44:59 GMT -->
</html>		