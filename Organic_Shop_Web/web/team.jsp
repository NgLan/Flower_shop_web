...
<!-- Mirrored from html.themexriver.com/organio/team.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Apr 2022 17:44:59 GMT -->
<head>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<title>Team | Organio</title>
	...
	<section id="or-breadcrumbs" class="or-breadcrumbs-section position-relative" data-background="assets/img/bg/bg-page-title.jpg">
		...
		<div class="container">
			<div class="or-breadcrumbs-content text-center">
				<div class="page-title headline"><h1>Team</h1></div>
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-6">
						<div class="or-team-innerbox">
							...
							<div class="or-taam-item-holder">
								<div class="or-team-meta text-center headline position-relative">
									<h3><a href="team-single.jsp">Sherri Horton</a></h3>
									<span>Customer Care Officer</span>
									<div class="team-item-side-img">
										<img class="side-img" src="assets/img/icon/t-icon2.png" alt="">
										<img class="side-img" src="assets/img/icon/t-icon1.png" alt="">
					...
					<div class="col-lg-4 col-md-6">
						<div class="or-team-innerbox">
							...
							<div class="or-taam-item-holder">
								<div class="or-team-meta text-center headline position-relative">
									<h3><a href="team-single.jsp"> Sinira Fro</a></h3>
									<span>Farmer</span>
									<div class="team-item-side-img">
										<img class="side-img" src="assets/img/icon/t-icon2.png" alt="">
										<img class="side-img" src="assets/img/icon/t-icon1.png" alt="">
					...
					<div class="col-lg-4 col-md-6">
						<div class="or-team-innerbox">
							...
							<div class="or-taam-item-holder">
								<div class="or-team-meta text-center headline position-relative">
									<h3><a href="team-single.jsp"> Alis Preston</a></h3>
									<span>Sales Executive</span>
									<div class="team-item-side-img">
										<img class="side-img" src="assets/img/icon/t-icon2.png" alt="">
										<img class="side-img" src="assets/img/icon/t-icon1.png" alt="">
						...
						<div class="or-footer-widget headline pera-content ul-li-block">
							<div class="or-contact-widget">
								...
								<ul>
									...
									<li><i class="fas fa-envelope"></i> <span> <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="71181f171e31141f0710051e5f121e1c">[email&#160;protected]</a>  </span> </li>
								</ul>
...
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"8a12a4faed8307ae","r":1,"version":"2024.4.1","token":"1a8b05cf689d4ce9a19f3112169b7af3"}' crossorigin="anonymous"></script>
</body>

<!-- Mirrored from html.themexriver.com/organio/team.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Apr 2022 17:45:00 GMT -->
</html>		